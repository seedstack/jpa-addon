...
class JpaOrConverter implements
        SpecificationConverter<OrSpecification<?>, JpaTranslationContext<?>, Predicate> {

    @Override
    public Predicate convert(OrSpecification<?> specification, JpaTranslationContext<?> context,
