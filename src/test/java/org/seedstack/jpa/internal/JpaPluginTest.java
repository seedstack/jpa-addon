...
public class JpaPluginTest {
    ...
    public void initTest() throws Exception {
        ...
        ApplicationProvider applicationProvider = mockApplicationProvider(
                mockConfiguration(Unit3ExceptionHandler.class.getName()));
        underTest.init(mockInitContext(applicationProvider, mockJdbcRegistry()));

        Map<String, JpaExceptionHandler> exceptionHandlerClasses = Reflection
                .field("exceptionHandlerClasses")
    ...
    private <T extends Plugin> InitContext mockInitContext(ApplicationProvider applicationProvider,
    ...
    public JpaConfig mockConfiguration(String itemExceptionHandlerName) throws Exception {
        return new JpaConfig().addUnit(
                ...
                new JpaConfig.PersistenceUnitConfig()
                        ...
                        .setExceptionHandler(
                                (Class<? extends JpaExceptionHandler>) Class.forName(itemExceptionHandlerName))
        );
    }
