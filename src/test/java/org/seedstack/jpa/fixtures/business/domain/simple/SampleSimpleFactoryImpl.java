...
public class SampleSimpleFactoryImpl extends BaseFactory<SampleSimpleJpaAggregateRoot> implements
        SampleSimpleFactory {

    @Override
    public SampleSimpleJpaAggregateRoot createSampleSimpleJpaAggregateRoot(Integer id, String f1,
            String f2, Date d3, String f4) {
